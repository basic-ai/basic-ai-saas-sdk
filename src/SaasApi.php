...
namespace BasicAiSaas;

use BasicAiSaas\Core\BaseException;
use BasicAiSaas\Helper\HttpHelper;
use BasicAiSaas\Helper\FormatHelper;
...
class SaasApi
{
    ...
    {
        $class = \ucfirst($class);
        $classNameSpace = 'BasicAiSaas\\Model\\' . $class;
